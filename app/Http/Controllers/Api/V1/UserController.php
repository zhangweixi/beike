...
class UserController extends Controller
{
    ...
    public function user_global_ability(Request $request)
    {
        ...
        $grades = [
            ...
            ["name"=>"长传能力","max"=>100,"self"=>self::def_grade($userAbility,"grade_pass_num_long",30)],
            ["name"=>"短传能力","max"=>100,"self"=>self::def_grade($userAbility,"grade_pass_num_short",30)],
    ...
    public function message_type(Request $request)
    {
        ...
        foreach($msgTypes as &$type){
            ...
            if(strlen($type['newMsg']) > 10){
                ...
                $type['newMsg'] = mb_substr($type['newMsg'],0,10).'...';
            }
        }
